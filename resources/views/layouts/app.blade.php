        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: purple">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="/Lambang.png" style="width: 60px; height: 70px;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}" style="font-weight: bold; font-size: 17px">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}" style="font-weight: bold; font-size: 17px">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown" >
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="background-color: black">
                                    <a class="dropdown-item" href="{{ url('cart') }}" style="color: white">
                                        {{ __('My Cart') }}
                                    </a>
